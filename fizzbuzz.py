...
def parse_args(args: List[str] = sys.argv[1:]) -> argparse.Namespace:
    ...
    g2 = parser.add_argument_group("fizzbuzz settings")
    g2.add_argument(
        "--fizz", metavar="N", default=3, type=int, help="Modulo value for fizz"
    )
    g2.add_argument(
        "--buzz", metavar="N", default=5, type=int, help="Modulo value for buzz"
    )
